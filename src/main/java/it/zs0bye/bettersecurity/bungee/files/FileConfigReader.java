...
public class FileConfigReader implements ConfigReader {
    ...
    public FileConfigReader(final BetterSecurityBungee plugin, final String path, final FileType type) {
        this.plugin = plugin;
        this.path = path;
        this.type = type;
        this.reloadConfig();
    ...
    public void send(final BetterUser user, final Map<String, String> placeholders, final String... var) {
        ...
        StringUtils.send((CommandSender) user.getSender(), message);
    }
    ...
    public void sendList(final BetterUser user, final Map<String, String> placeholders, final String... var) {
        ...
        this.getStringList(var).forEach(msg -> {
            ...
            ((CommandSender) user.getSender()).sendMessage(TextComponent.fromLegacyText(this.getCustomString(msg)));
        });
    }
