...
public class HelpSubCMD extends BaseCommand {
    ...
    public HelpSubCMD(final String command, final CommandSender sender, final String alias, final BetterSecurity plugin) {
    ...
    public HelpSubCMD(final String command, final String[] args, final CommandSender sender, final String alias, final BetterSecurity plugin) {
        this.command = command;
        this.args = args;
        this.sender = sender;
        this.alias = alias;
    ...
    public HelpSubCMD(final String command, final List<String> tab, final String[] args, final CommandSender sender, final BetterSecurity plugin) {
        this.command = command;
        this.sender = sender;
        this.plugin = plugin;
        if(!args[0].equalsIgnoreCase(getName())) return;
