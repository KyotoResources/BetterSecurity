...
import it.zs0bye.bettersecurity.commands.subcmds.AboutSubCMD;
import it.zs0bye.bettersecurity.commands.subcmds.HelpSubCMD;
import it.zs0bye.bettersecurity.commands.subcmds.ReloadSubCMD;
...
public class MainCommand implements CommandExecutor, TabCompleter {
    ...
    public MainCommand(final BetterSecurity plugin) {
        this.plugin = plugin;
